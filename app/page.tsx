    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 px-[var(--grid-padding)] lg:px-[var(--grid-padding-lg)]">
        ...
        <main className="lg:col-span-9 pt-[var(--space-16)] md:pt-[100px]">
          ...
          <section id="hero" className="pb-[var(--space-12)] md:pb-[80px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 pt-8 border-t border-[var(--border-subtle)]">
              <div>
                ...
                <p className="text-[var(--text-sm)] text-[var(--text-muted)] mt-2">Coinbase total volume</p>
              </div>
              <div>
                <p className="text-[clamp(2.5rem,6vw,4rem)] text-display text-[var(--text-primary)] leading-none">
                  2M+
                </p>
                <p className="text-[var(--text-sm)] text-[var(--text-muted)] mt-2">distinct token pairs</p>
              </div>
              <div>
                <p className="text-[clamp(2.5rem,6vw,4rem)] text-display text-[var(--text-primary)] leading-none">
                  5.6M
                </p>
                <p className="text-[var(--text-sm)] text-[var(--text-muted)] mt-2">distinct transactions</p>
              </div>
            </div>
          </section>

          {/* About Coinbase - Brief Context */}
          <section id="about" className="py-[var(--space-16)] bg-[var(--bg-card)] -mx-[var(--grid-padding)] px-[var(--grid-padding)] lg:-mx-0 lg:px-8 lg:rounded-3xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
          ...
          <section id="products" className="py-[var(--space-20)]">
          ...
          {/* The Shift Section */}
          <section id="shift" className="py-[var(--space-20)] border-t border-[var(--border-subtle)]">
          ...
          <section id="opportunity" className="py-[var(--space-20)] bg-[var(--bg-card)] -mx-[var(--grid-padding)] px-[var(--grid-padding)] lg:-mx-0 lg:px-8 lg:rounded-3xl">
          ...
          {/* Why 0x Section */}
          <section id="why-0x" className="py-[var(--space-24)]">
          ...
          {/* CTA Section */}
          <section id="cta" className="py-[var(--space-24)] bg-[#26272b] -mx-[var(--grid-padding)] px-[var(--grid-padding)] lg:-mx-0 lg:px-8 lg:rounded-3xl mb-8">
