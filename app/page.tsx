    ...
    <div className="min-h-screen" style={{ backgroundColor: '#ffffff' }}>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="mb-20 flex h-48 items-center justify-center" style={{ backgroundColor: '#d9d9d9' }}>
          <p className="text-3xl" style={{ color: '#ffffff' }}>Sign up form</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-0 md:grid-cols-2">
          ...
          <div className="flex min-h-[340px] flex-col justify-between p-10" style={{ backgroundColor: '#c8d4fa' }}>
            <h2 className="text-4xl font-normal" style={{ color: '#1d1d1d' }}>Build onchain</h2>
          ...
          <div className="flex min-h-[340px] flex-col justify-between p-10" style={{ backgroundColor: '#0052ff' }}>
            <h2 className="text-4xl font-normal" style={{ color: '#ffffff' }}>Onchain tools</h2>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:gap-4">
              <div className="flex-1">
                ...
                <Input
                  ...
                  style={{ color: '#5d5d5d' }}
                />
                <p className="mt-2 text-xs" style={{ color: '#5d5d5d' }}>Sign up for our newsletter</p>
              </div>
