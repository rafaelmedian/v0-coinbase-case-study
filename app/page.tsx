    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pb-20">
        ...
        <button
          ...
          className="group relative z-10 flex w-full items-center justify-between rounded-tl-[30px] rounded-tr-[30px] bg-[#c8d4fa] px-8 py-12 transition-all hover:bg-[#b8c4ea]"
        >
        ...
        <button
          ...
          className="group relative z-20 -mt-6 flex w-full items-center justify-between rounded-tl-[30px] rounded-tr-[30px] bg-[#0052ff] px-8 py-12 transition-all hover:bg-[#0048dd]"
        >
          <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="group relative z-30 -mt-6 flex w-full items-center justify-between rounded-tl-[30px] rounded-tr-[30px] bg-[#1d1d1d] px-8 py-12 transition-all hover:bg-[#2d2d2d]"
        >
          <div className="flex items-center gap-4">
